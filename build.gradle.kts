...
dependencies {
    ...
    testImplementation("io.github.manamiproject:modb-test:1.4.0c")
}
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                description.set("This lib contains downloader and converter for downloading raw data from myanimelist.net and convert it to an anime object.")
